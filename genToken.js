...
client.on('authenticated', (session) => {
    ...
    fs.readFile(__dirname + '/session.json', { encoding: 'utf8' }, function(err, data) {
        if (err) {
            ...
            console.log("\n\nToken also saved on a file named session.json in this directory. Please delete this file after copy if you will use enviroment variable.please subscribe Youtube-CYBERKALLAN")
            process.exit()
        } else {
